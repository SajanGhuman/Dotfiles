# Generated by Powerlevel10k configuration wizard on 2024-12-19 at 10:39 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHOW_WRITABLE=true       # Optional: Show writable indicator.
typeset -g POWERLEVEL9K_DIR_MIN_COMMAND_COLUMNS=40  # Adjust minimum space for dir.
typeset -g POWERLEVEL9K_SHORTEN_STRATEGY="truncate_to_last" # Show only parent dir.
typeset -g POWERLEVEL9K_SHORTEN_DIR_LENGTH=1         # Show only 1 segment (last dir).


  # Show only the branch name without symbols or status indicators.
  # # Remove all symbols and show only the branch name.
typeset -g POWERLEVEL9K_VCS_BRANCH_ICON=''              # Remove branch icon.
typeset -g POWERLEVEL9K_VCS_STAGED_ICON=''              # No staged indicator.
typeset -g POWERLEVEL9K_VCS_UNSTAGED_ICON=''            # No unstaged indicator.
typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON=''           # No untracked indicator.
typeset -g POWERLEVEL9K_VCS_INCOMING_CHANGES_ICON=''    # No incoming changes.
typeset -g POWERLEVEL9K_VCS_OUTGOING_CHANGES_ICON=''    # No outgoing changes.
typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='${vcs_branch}' # Show only branch name.
typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='${${vcs_branch:#master}:+$vcs_branch}' # Branch name only.
typeset -g POWERLEVEL9K_VCS_MAX_SYNC_LATENCY_SECONDS=0 # Disable latency indicators.
typeset -g POWERLEVEL9K_VCS_DISABLE_GITSTATUS=true   # Disable Git status.
...
function my_git_formatter() {
  ...
  if [[ -n $P9K_CONTENT ]]; then
    # If P9K_CONTENT is not empty, use it. This handles "loading" or vcs_info fallback.
    typeset -g my_git_format=$P9K_CONTENT
    return
  fi

  if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
    # Display only the Git branch name.
    typeset -g my_git_format="${VCS_STATUS_LOCAL_BRANCH//\%/%%}"
  else
    # Fallback if no branch is found.
    typeset -g my_git_format="(no branch)"
  fi
}
  ...
  # Remove icons like "?1" or "!1" after the branch name.
  typeset -g POWERLEVEL9K_VCS_HIDE_TAGS=true
  typeset -g POWERLEVEL9K_VCS_HIDE_STATUS=true
